...
// SignInWithPassword 用户使用密码登录
func (repo *UserRepo) SignInWithPassword(ctx context.Context, emailOrPhone, password string) (*model.Users, error) {
...
func (repo *UserRepo) SignInWithWeChat(ctx context.Context, unionID string, nickname string, avatarURL string) (user *model.Users, eventID int64, err error) {
...
func (repo *UserRepo) SignInWithApple(
	ctx context.Context,
	appleUID string,
	email string,
	isPrivateEmail bool,
